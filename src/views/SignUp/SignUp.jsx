...
function RegistrationForm(props)  {
    ...
    console.log(props.routeAttempted)

    const onFinish = values => {
        console.log('Received values of form: ', values);
       

        props.signup(values.firstName,values.lastName, values.email,values.password).then(() => props.history.push(props.routeAttempted ? props.routeAttempted : "/"))
                                ...
                                <div style={{ display: "flex", justifyContent: "center"}}>
                                    ...
                                    >
                                        ...
                                        <div style={{textAlign: "center"}}>
                                            Already have an account? <span className="link" onClick={()=>{props.history.push("/login")}}>Sign In</span>
                                        </div>
                                    </Form>
                                </div>
                            </Layout.Content>
